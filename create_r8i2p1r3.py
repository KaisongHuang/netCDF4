...
def create_file(yyyy):
    file_path = '/project/rpp-hwheater/k86huang/canrcm4-wfdei-gem-capa/r8i2p1r3/' + yyyy + '_r8i2p1r3.nc'
    ...
    nc.experiment = "CanSISE downscaling run driven by CCCma-CanESM2 eic-008"#eia-008
    nc.experiment_id = "historical-r3"#historical-r1
    nc.driving_experiment = "CCCma-CanESM2, historical-r3, r8i2p1"#historical-r1, r8i2p1
    ...
    nc.frequency = "1hr"
    nc.product = "output"
    nc.CCCma_runid = "nam44_v002_eic-008"#eia-008
    nc.creation_date = "2016-12-12-T21:03:35Z"#2016-12-13-T17:48:26Z
