...
def create_file(yyyy):
    file_path = '/project/rpp-hwheater/k86huang/canrcm4-wfdei-gem-capa/r9i2p1r5/' + yyyy + '_r9i2p1r5.nc'
    ...
    nc.experiment = "CanSISE downscaling run driven by CCCma-CanESM2 eie-009"#eia-008
    nc.experiment_id = "historical-r5"#historical-r1
    nc.driving_experiment = "CCCma-CanESM2, historical-r5, r9i2p1"#historical-r1, r8i2p1
    ...
    nc.frequency = "1hr"
    nc.product = "output"
    nc.CCCma_runid = "nam44_v002_eie-009"#eia-008
    nc.creation_date = "2016-12-13-T00:39:10Z"#2016-12-13-T17:48:26Z
