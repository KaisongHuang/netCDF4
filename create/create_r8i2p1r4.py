...
def create_file(yyyy):
    file_path = '/project/rpp-hwheater/k86huang/canrcm4-wfdei-gem-capa/r8i2p1r4/' + yyyy + '_r8i2p1r4.nc'
    ...
    nc.experiment = "CanSISE downscaling run driven by CCCma-CanESM2 eid-008"#eia-008
    nc.experiment_id = "historical-r4"#historical-r1
    nc.driving_experiment = "CCCma-CanESM2, historical-r4, r8i2p1"#historical-r1, r8i2p1
    ...
    nc.frequency = "1hr"
    nc.product = "output"
    nc.CCCma_runid = "nam44_v002_eid-008"#eia-008
    nc.creation_date = "2016-12-13-T17:48:47Z"#2016-12-13-T17:48:26Z
