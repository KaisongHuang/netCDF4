...
def create_file(yyyy):
    file_path = '/project/rpp-hwheater/k86huang/canrcm4-wfdei-gem-capa/r10i2p1r5/' + yyyy + '_r10i2p1r5.nc'
    ...
    nc.experiment = "CanSISE downscaling run driven by CCCma-CanESM2 eie-010"#eia-008
    nc.experiment_id = "historical-r5"#historical-r1
    nc.driving_experiment = "CCCma-CanESM2, historical-r5, r10i2p1"#historical-r1, r8i2p1
    nc.driving_model_id = "CCCma-CanESM2"
    nc.driving_experiment_name = "historical-r5"#historical-r1
    nc.driving_model_ensemble_member = "r10i2p1"
    nc.realization = "10"
    ...
    nc.frequency = "1hr"
    nc.product = "output"
    nc.CCCma_runid = "nam44_v002_eie-010"#eia-008
    nc.creation_date = "2016-12-15-T00:01:21Z"#2016-12-13-T17:48:26Z
